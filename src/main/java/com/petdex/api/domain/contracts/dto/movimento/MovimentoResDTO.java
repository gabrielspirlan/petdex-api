...
public class MovimentoResDTO {
    ...
    @Schema(description = "Código único identificador do movimento", example = "", requiredMode = Schema.RequiredMode.REQUIRED)
    private String id;
    ...
    public MovimentoResDTO(String id, Date date, Double acelerometroX, Double acelerometroY, Double acelerometroZ, Double giroscopioX, Double giroscopioY, Double giroscopioZ, String animalId, String coleiraId) {
        this.id = id;
        this.date = date;
